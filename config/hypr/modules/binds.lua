...
hl.bind(mod .. " + ALT + S", hl.dsp.exec_cmd("qs ipc call saver preview"))
...
hl.bind(mod .. " + TAB",         hl.dsp.workspace.toggle_special("aux"))
hl.bind(mod .. " + SHIFT + TAB", hl.dsp.window.move({ workspace = "special:aux" }))
