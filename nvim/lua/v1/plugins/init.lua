return {
  ...
  ---@see https://github.com/rcarriga/nvim-notify
  {
    ...
    config = function()
      require("notify").setup(require("v1.plugins.config.nvim-notify"))
      vim.notify = notify
    end,
  },
  ...
  ---@see https://github.com/lukas-reineke/indent-blankline.nvim
  {
    ...
    config = function()
      require("indent_blankline").setup(require("v1.plugins.config.indent-blankline"))
    end,
  },
  ...
  ---@see https://github.com/j-hui/fidget.nvim
  {
    "j-hui/fidget.nvim",
    config = function()
      require("fidget").setup(require("v1.plugins.config.fidget"))
    end,
  },
  ...
  ---@see https://github.com/akinsho/bufferline.nvim
  {
    ...
    config = function()
      require("bufferline").setup(require("v1.plugins.config.bufferline"))
    end,
  },
  ...
  ---@see https://github.com/nvim-lualine/lualine.nvim
  {
    ...
    requires = { "nvim-tree/nvim-web-devicons" },
    config = function()
      require("lualine").setup(require("v1.plugins.config.lualine"))
    end,
  },
  ...
  -- tokyonight
  {
    ...
    config = function()
      require("tokyonight").setup(require("v1.plugins.config.tokyonight"))
    end,
  },
  ...
  { "kylechui/nvim-surround",
    config = function()
      require("nvim-surround").setup(require("v1.plugins.config.nvim-surround"))
    end,
  },
  ...
  { "windwp/nvim-autopairs",
    config = function()
      require("nvim-autopairs").setup(require("v1.plugins.config.nvim-autopairs"))
  ...
  ---@see https://github.com/folke/todo-comments.nvim
  {
    ...
    config = function()
      require("todo-comments").setup(require("v1.plugins.config.todo-comments"))
    end,
  },
  ...
  ---@see https://github.com/jbyuki/venn.nvim
  {
    "jbyuki/venn.nvim",
    config = function()
      require("venn").setup(require("v1.plugins.config.venn"))
    end,
  },
  ...
  ---@see https://github.com/folke/zen-mode.nvim
  {
    "folke/zen-mode.nvim",
    config = function()
      require("zen-mode").setup(require("v1.plugins.config.zen-mode"))
    end,
  },
  ...
  ---@see https://github.com/jakewvincent/mkdnflow.nvim
  {
    ...
    config = function()
      require("mkdnflow").setup(require("v1.plugins.config.mkdnflow"))
    end,
    ft = { "markdown" }
  },
  ...
  ---@see https://github.com/numToStr/Comment.nvim
  {
    ...
    config = function()
      require("comment").setup(require("v1.plugins.config.comment"))
    end,
  },
  ...
  ---@see https://github.com/nvim-tree/nvim-tree.lua
  {
    ...
    requires = { "nvim-tree/nvim-web-devicons" },
    config = function()
      require("nvim-tree").setup(require("v1.plugins.config.nvim-tree"))
  ...
  ---@see https://github.com/nvim-telescope/telescope.nvim
  {
    ...
    config = function()
      ...
      telescope.setup(require("v1.plugins.config.telescope"))
  ...
  ---@see https://github.com/nvim-treesitter/nvim-treesitter
  {
    ...
    config = function()
      require("nvim-treesitter.configs").setup(require("v1.plugins.config.treesitter"))
  ...
  { "lewis6991/gitsigns.nvim",
    config = function()
      require("gitsigns").setup(require("v1.plugins.config.gitsigns"))
    end,
  },
  ...
  { "nvim-neotest/neotest",
    config = function()
      require("neotest").setup(require("v1.plugins.config.nvim-neotest"))
    end,
  },
